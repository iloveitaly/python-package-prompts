...
pull-upstream:
    {{just_executable()}} _retrieve {{upstream_repo / ".github/instructions/python.instructions.md"}}
    {{just_executable()}} _retrieve {{upstream_repo / ".github/copilot-instructions.md"}}
